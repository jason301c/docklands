...
import { instanceofZodType, instanceofZodTypeCoercible, instanceofZodTypeKind, instanceofZodTypeLikeString, instanceofZodTypeLikeVoid, instanceofZodTypeOptional, instanceofZodFormDataFile, isSchemaOptional, schemaContainsFileField, unwrapZodType, zodSupportsCoerce, } from '../utils/index.mjs';
 ...
 */
const generateFormDataSchema = (zodSchema) => {
