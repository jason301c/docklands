 ...
 *
 * Usage:
 *   OLD_SECRET=<old_secret> NEW_SECRET=<new_secret> npx tsx scripts/migrate-auth-secret.ts
 *
...
if (!OLD_SECRET || !NEW_SECRET) {
	...
	console.error(
		"   Usage: OLD_SECRET=<old> NEW_SECRET=<new> npx tsx scripts/migrate-auth-secret.ts",
	);
	process.exit(1);
}
