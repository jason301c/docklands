			...
			<DialogContent className="sm:max-w-7xl min-h-[75vh]">
				...
				<DialogHeader>
					...
					<DialogDescription className="text-center max-w-xl mx-auto">
						Thank you for choosing Docklands Cloud! 🚀 We're excited to have you
								...
								return (
									<div className="flex flex-col gap-6">
										<div className="flex flex-col gap-2">
											...
											<p className="text-muted-foreground">
												Here are some of the things you can do with Docklands
												Cloud:
											</p>
										</div>
											...
											<div className="flex flex-row gap-4">
												<Button className="rounded-full bg-[#5965F2] hover:bg-[#4A55E0] w-fit">
													<Link
														...
														aria-label="Docklands on GitHub"
														target="_blank"
