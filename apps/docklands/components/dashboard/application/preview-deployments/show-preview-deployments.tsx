...
export const ShowPreviewDeployments = ({ applicationId }: Props) => {
	...
	const previewDeploymentsQuery = api.previewDeployment.all.useQuery(
		{ applicationId },
		{
	...
	const { refetch: refetchPreviewDeployments } = previewDeploymentsQuery;
			...
			<div className="flex flex-col gap-4">
				{data?.isPreviewDeploymentsActive ? (
					<>
						...
						<QueryState
							query={previewDeploymentsQuery}
							isEmpty={(previewDeployments) => !previewDeployments.length}
							loadingLabel="Loading preview environments..."
							empty={
							...
							errorTitle="Failed to load preview environments"
						>
							{(previewDeployments) => (
								<div className="flex flex-col gap-4">
