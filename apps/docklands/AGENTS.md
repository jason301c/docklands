...
- Product route aliases should be preferred in navigation and new links: `/dashboard/runtime` over `/dashboard/docker`, `/dashboard/orchestration` over `/dashboard/swarm`, `/dashboard/ingress` over `/dashboard/traefik`, `/dashboard/settings/ingress` over `/dashboard/settings/server`, `/dashboard/settings/runtime` over `/dashboard/settings/servers`, and `/dashboard/settings/storage` over `/dashboard/settings/destinations`.
