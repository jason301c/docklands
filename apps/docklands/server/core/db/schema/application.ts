...
const createSchema = createInsertSchema(applications, {
	...
	buildArgs: z.string().nullish(),
	buildSecrets: z.string().nullish(),
	name: z.string().min(1),
	...
	dockerImage: z.string().nullish(),
	username: z.string().nullish(),
	isPreviewDeploymentsActive: z.boolean().nullish(),
	...
	dockerContextPath: z.string().nullish(),
	dockerBuildStage: z.string().nullish(),
	branch: z.string().nullish(),
	customGitBranch: z.string().nullish(),
	customGitBuildPath: z.string().nullish(),
	customGitUrl: z.string().nullish(),
	buildPath: z.string().nullish(),
	...
	railpackVersion: z.string().nullish(),
	herokuVersion: z.string().nullish(),
	publishDirectory: z.string().nullish(),
	isStaticSpa: z.boolean().nullish(),
	...
	previewPort: z.number().nullish(),
	previewEnv: z.string().nullish(),
	previewBuildArgs: z.string().nullish(),
	...
	previewCustomCertResolver: z.string().nullish(),
	previewRequireCollaboratorPermissions: z.boolean().optional(),
	watchPaths: z.array(z.string()).nullish(),
	previewLabels: z.array(z.string()).nullish(),
	cleanCache: z.boolean().nullish(),
