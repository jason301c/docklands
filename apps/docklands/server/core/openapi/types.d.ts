...
export type OpenApiContentType = 'application/json' | 'application/x-www-form-urlencoded' | 'multipart/form-data' | (string & {});
 ...
 */
export type ResolvedOpenApiMeta = Required<Pick<NonNullable<OpenApiMeta['openapi']>, 'method' | 'path'>> & NonNullable<OpenApiMeta['openapi']>;
