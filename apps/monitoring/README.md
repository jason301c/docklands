# Docklands Monitoring (Go Version)

Application that powers Docklands's monitoring service.
...
Docklands uses a callback URL to send notifications when metrics exceed configured thresholds. Notifications are sent via POST request in the following format:
